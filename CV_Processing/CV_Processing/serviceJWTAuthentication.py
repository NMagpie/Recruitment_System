...
from CV_Processing.settings import SHARED_SECRET_KEY, USER_AUTH_SECRET_KEY, SERVICE_AUTH_SECRET_KEY, SERVICE_NAME, \
    REGISTER_URL, REFRESH_URL, APP_PORT_VAR, EUREKA_URL, EUREKA_URL_DEFAULT_ZONE
